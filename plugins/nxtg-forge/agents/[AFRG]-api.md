...
description: |
  ...
  assistant: "I'll use the api agent to design and implement the endpoint with validation."
  <commentary>
  API endpoint creation with proper validation is a api task.
  </commentary>
  </example>
  ...
  assistant: "I'll use the api agent to implement the GitHub API integration."
  <commentary>
  External API integration is a api specialty.
  </commentary>
  </example>
model: sonnet
color: cyan
